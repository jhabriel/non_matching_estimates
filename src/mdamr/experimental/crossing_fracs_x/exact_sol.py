...
class TwoCrossingExactSolution:
    ...
    def __init__(self):
        ...
        lmbda_5 = sym.nsimplify(q_6[1][0].subs({"x": 0.5 + tol}), tolerance=tol) * -1
        lmbda_6 = sym.nsimplify(q_6[1][1].subs({"y": 0.5 + tol}), tolerance=tol) * -1
        lmbda_7 = sym.nsimplify(q_6[1][1].subs({"y": 0.5 - tol}), tolerance=tol) * 1
        lmbda_8 = sym.nsimplify(q_6[1][0].subs({"x": 0.5 + tol}), tolerance=tol) * -1
        lmbda_9 = sym.nsimplify(q_6[1][0].subs({"x": 0.5 - tol}), tolerance=tol) * 1
        lmbda_10 = sym.nsimplify(q_6[1][1].subs({"y": 0.5 - tol}), tolerance=tol) * 1
        lmbda_11 = sym.nsimplify(q_6[1][1].subs({"y": 0.5 + tol}), tolerance=tol) * -1
        lmbda_12 = sym.nsimplify(q_6[1][0].subs({"x": 0.5 - tol}), tolerance=tol) * 1
        ...
        tr_p_6_at_5 = sym.nsimplify(p_6[1].subs({"x": 0.5 + tol}), tolerance=tol)
        tr_p_6_at_6 = sym.nsimplify(p_6[1].subs({"y": 0.5 + tol}), tolerance=tol)
        tr_p_6_at_7 = sym.nsimplify(p_6[1].subs({"y": 0.5 - tol}), tolerance=tol)
        tr_p_6_at_8 = sym.nsimplify(p_6[1].subs({"x": 0.5 + tol}), tolerance=tol)
        tr_p_6_at_9 = sym.nsimplify(p_6[1].subs({"x": 0.5 - tol}), tolerance=tol)
        tr_p_6_at_10 = sym.nsimplify(p_6[1].subs({"y": 0.5 - tol}), tolerance=tol)
        tr_p_6_at_11 = sym.nsimplify(p_6[1].subs({"y": 0.5 + tol}), tolerance=tol)
        tr_p_6_at_12 = sym.nsimplify(p_6[1].subs({"x": 0.5 - tol}), tolerance=tol)
    ...
    def get_2d_subregions(
        ...
        subregion_1 = xc[1] > 0.75  # top
        subregion_2 = (xc[1] > 0.25) & (xc[1] < 0.75)  # middle
        subregion_3 = xc[1] < 0.25  # bottom
