...
Physical Line("FRACTURE_INTERSECTION_LINE_49") = {frac_line_49};
...
Physical Line("FRACTURE_INTERSECTION_LINE_51") = {frac_line_51};

frac_line_52= newl; Line(frac_line_52) = {p13, p29};
Physical Line("FRACTURE_INTERSECTION_LINE_52") = {frac_line_52};

frac_line_53= newl; Line(frac_line_53) = {p13, p33};
Physical Line("FRACTURE_INTERSECTION_LINE_53") = {frac_line_53};

frac_line_54= newl; Line(frac_line_54) = {p13, p48};
Physical Line("FRACTURE_INTERSECTION_LINE_54") = {frac_line_54};
...
Physical Line("FRACTURE_INTERSECTION_LINE_63") = {frac_line_63};
...
Physical Line("FRACTURE_INTERSECTION_LINE_66") = {frac_line_66};
...
Physical Line("FRACTURE_INTERSECTION_LINE_73") = {frac_line_73};

frac_line_74= newl; Line(frac_line_74) = {p20, p24};
Physical Line("FRACTURE_INTERSECTION_LINE_74") = {frac_line_74};

frac_line_75= newl; Line(frac_line_75) = {p20, p30};
Physical Line("FRACTURE_INTERSECTION_LINE_75") = {frac_line_75};

frac_line_76= newl; Line(frac_line_76) = {p20, p35};
Physical Line("FRACTURE_INTERSECTION_LINE_76") = {frac_line_76};

frac_line_77= newl; Line(frac_line_77) = {p20, p47};
Physical Line("FRACTURE_INTERSECTION_LINE_77") = {frac_line_77};
...
Physical Line("FRACTURE_INTERSECTION_LINE_79") = {frac_line_79};
...
Physical Line("FRACTURE_INTERSECTION_LINE_86") = {frac_line_86};

frac_line_87= newl; Line(frac_line_87) = {p24, p56};
Physical Line("FRACTURE_INTERSECTION_LINE_87") = {frac_line_87};

frac_line_88= newl; Line(frac_line_88) = {p24, p59};
Physical Line("FRACTURE_INTERSECTION_LINE_88") = {frac_line_88};

frac_line_89= newl; Line(frac_line_89) = {p24, p62};
Physical Line("FRACTURE_INTERSECTION_LINE_89") = {frac_line_89};

frac_line_90= newl; Line(frac_line_90) = {p25, p52};
Physical Line("FRACTURE_INTERSECTION_LINE_90") = {frac_line_90};

frac_line_91= newl; Line(frac_line_91) = {p25, p56};
Physical Line("FRACTURE_INTERSECTION_LINE_91") = {frac_line_91};

frac_line_92= newl; Line(frac_line_92) = {p25, p58};
Physical Line("FRACTURE_INTERSECTION_LINE_92") = {frac_line_92};

frac_line_93= newl; Line(frac_line_93) = {p26, p50};
Physical Line("FRACTURE_INTERSECTION_LINE_93") = {frac_line_93};

frac_line_94= newl; Line(frac_line_94) = {p26, p57};
Physical Line("FRACTURE_INTERSECTION_LINE_94") = {frac_line_94};

frac_line_95= newl; Line(frac_line_95) = {p26, p58};
Physical Line("FRACTURE_INTERSECTION_LINE_95") = {frac_line_95};

frac_line_96= newl; Line(frac_line_96) = {p26, p63};
Physical Line("FRACTURE_INTERSECTION_LINE_96") = {frac_line_96};

frac_line_97= newl; Line(frac_line_97) = {p27, p55};
Physical Line("FRACTURE_INTERSECTION_LINE_97") = {frac_line_97};

frac_line_98= newl; Line(frac_line_98) = {p27, p57};
Physical Line("FRACTURE_INTERSECTION_LINE_98") = {frac_line_98};

frac_line_99= newl; Line(frac_line_99) = {p27, p59};
Physical Line("FRACTURE_INTERSECTION_LINE_99") = {frac_line_99};

frac_line_100= newl; Line(frac_line_100) = {p28, p50};
Physical Line("FRACTURE_INTERSECTION_LINE_100") = {frac_line_100};

frac_line_101= newl; Line(frac_line_101) = {p28, p57};
Physical Line("FRACTURE_INTERSECTION_LINE_101") = {frac_line_101};

frac_line_102= newl; Line(frac_line_102) = {p28, p60};
Physical Line("FRACTURE_INTERSECTION_LINE_102") = {frac_line_102};

frac_line_103= newl; Line(frac_line_103) = {p29, p56};
Physical Line("FRACTURE_INTERSECTION_LINE_103") = {frac_line_103};

frac_line_104= newl; Line(frac_line_104) = {p29, p60};
Physical Line("FRACTURE_INTERSECTION_LINE_104") = {frac_line_104};

frac_line_105= newl; Line(frac_line_105) = {p29, p62};
Physical Line("FRACTURE_INTERSECTION_LINE_105") = {frac_line_105};

frac_line_106= newl; Line(frac_line_106) = {p30, p52};
Physical Line("FRACTURE_INTERSECTION_LINE_106") = {frac_line_106};

frac_line_107= newl; Line(frac_line_107) = {p30, p56};
Physical Line("FRACTURE_INTERSECTION_LINE_107") = {frac_line_107};

frac_line_108= newl; Line(frac_line_108) = {p30, p61};
Physical Line("FRACTURE_INTERSECTION_LINE_108") = {frac_line_108};

frac_line_109= newl; Line(frac_line_109) = {p31, p55};
Physical Line("FRACTURE_INTERSECTION_LINE_109") = {frac_line_109};

frac_line_110= newl; Line(frac_line_110) = {p31, p57};
Physical Line("FRACTURE_INTERSECTION_LINE_110") = {frac_line_110};

frac_line_111= newl; Line(frac_line_111) = {p31, p61};
Physical Line("FRACTURE_INTERSECTION_LINE_111") = {frac_line_111};

frac_line_112= newl; Line(frac_line_112) = {p31, p63};
Physical Line("FRACTURE_INTERSECTION_LINE_112") = {frac_line_112};

frac_line_113= newl; Line(frac_line_113) = {p32, p59};
Physical Line("FRACTURE_INTERSECTION_LINE_113") = {frac_line_113};

frac_line_114= newl; Line(frac_line_114) = {p32, p60};
Physical Line("FRACTURE_INTERSECTION_LINE_114") = {frac_line_114};

frac_line_115= newl; Line(frac_line_115) = {p32, p62};
Physical Line("FRACTURE_INTERSECTION_LINE_115") = {frac_line_115};

frac_line_116= newl; Line(frac_line_116) = {p33, p50};
Physical Line("FRACTURE_INTERSECTION_LINE_116") = {frac_line_116};

frac_line_117= newl; Line(frac_line_117) = {p33, p58};
Physical Line("FRACTURE_INTERSECTION_LINE_117") = {frac_line_117};

frac_line_118= newl; Line(frac_line_118) = {p33, p60};
Physical Line("FRACTURE_INTERSECTION_LINE_118") = {frac_line_118};

frac_line_119= newl; Line(frac_line_119) = {p34, p52};
Physical Line("FRACTURE_INTERSECTION_LINE_119") = {frac_line_119};

frac_line_120= newl; Line(frac_line_120) = {p34, p58};
Physical Line("FRACTURE_INTERSECTION_LINE_120") = {frac_line_120};

frac_line_121= newl; Line(frac_line_121) = {p34, p61};
Physical Line("FRACTURE_INTERSECTION_LINE_121") = {frac_line_121};

frac_line_122= newl; Line(frac_line_122) = {p34, p63};
Physical Line("FRACTURE_INTERSECTION_LINE_122") = {frac_line_122};

frac_line_123= newl; Line(frac_line_123) = {p35, p55};
Physical Line("FRACTURE_INTERSECTION_LINE_123") = {frac_line_123};

frac_line_124= newl; Line(frac_line_124) = {p35, p59};
Physical Line("FRACTURE_INTERSECTION_LINE_124") = {frac_line_124};

frac_line_125= newl; Line(frac_line_125) = {p35, p61};
Physical Line("FRACTURE_INTERSECTION_LINE_125") = {frac_line_125};

frac_line_126= newl; Line(frac_line_126) = {p44, p62};
Physical Line("FRACTURE_INTERSECTION_LINE_126") = {frac_line_126};

frac_line_127= newl; Line(frac_line_127) = {p46, p62};
Physical Line("FRACTURE_INTERSECTION_LINE_127") = {frac_line_127};

frac_line_128= newl; Line(frac_line_128) = {p49, p62};
Physical Line("FRACTURE_INTERSECTION_LINE_128") = {frac_line_128};

frac_line_129= newl; Line(frac_line_129) = {p51, p63};
Physical Line("FRACTURE_INTERSECTION_LINE_129") = {frac_line_129};

frac_line_130= newl; Line(frac_line_130) = {p53, p63};
Physical Line("FRACTURE_INTERSECTION_LINE_130") = {frac_line_130};

frac_line_131= newl; Line(frac_line_131) = {p54, p63};
Physical Line("FRACTURE_INTERSECTION_LINE_131") = {frac_line_131};

frac_line_132= newl; Line(frac_line_132) = {p56, p64};
Physical Line("FRACTURE_INTERSECTION_LINE_132") = {frac_line_132};

frac_line_133= newl; Line(frac_line_133) = {p57, p64};
Physical Line("FRACTURE_INTERSECTION_LINE_133") = {frac_line_133};

frac_line_134= newl; Line(frac_line_134) = {p58, p64};
Physical Line("FRACTURE_INTERSECTION_LINE_134") = {frac_line_134};

frac_line_135= newl; Line(frac_line_135) = {p59, p64};
Physical Line("FRACTURE_INTERSECTION_LINE_135") = {frac_line_135};

frac_line_136= newl; Line(frac_line_136) = {p60, p64};
Physical Line("FRACTURE_INTERSECTION_LINE_136") = {frac_line_136};

frac_line_137= newl; Line(frac_line_137) = {p61, p64};
Physical Line("FRACTURE_INTERSECTION_LINE_137") = {frac_line_137};
...
Physical Surface("AUXILIARY_PLANE_9") = {auxiliary_9};
...
Physical Surface("AUXILIARY_PLANE_10") = {auxiliary_10};
...
Physical Surface("AUXILIARY_PLANE_11") = {auxiliary_11};
...
Physical Surface("AUXILIARY_PLANE_12") = {auxiliary_12};
...
Physical Surface("AUXILIARY_PLANE_13") = {auxiliary_13};
...
Physical Surface("AUXILIARY_PLANE_14") = {auxiliary_14};
...
Physical Point("FRACTURE_INTERSECTION_POINT_0") = {p13};
Physical Point("FRACTURE_INTERSECTION_POINT_1") = {p16};
Physical Point("FRACTURE_INTERSECTION_POINT_2") = {p20};
Physical Point("FRACTURE_INTERSECTION_POINT_3") = {p24};
Physical Point("FRACTURE_INTERSECTION_POINT_4") = {p25};
Physical Point("FRACTURE_INTERSECTION_POINT_5") = {p26};
Physical Point("FRACTURE_INTERSECTION_POINT_6") = {p27};
Physical Point("FRACTURE_INTERSECTION_POINT_7") = {p28};
Physical Point("FRACTURE_INTERSECTION_POINT_8") = {p29};
Physical Point("FRACTURE_INTERSECTION_POINT_9") = {p30};
Physical Point("FRACTURE_INTERSECTION_POINT_10") = {p31};
Physical Point("FRACTURE_INTERSECTION_POINT_11") = {p32};
Physical Point("FRACTURE_INTERSECTION_POINT_12") = {p33};
Physical Point("FRACTURE_INTERSECTION_POINT_13") = {p34};
Physical Point("FRACTURE_INTERSECTION_POINT_14") = {p35};
Physical Point("FRACTURE_INTERSECTION_POINT_15") = {p50};
Physical Point("FRACTURE_INTERSECTION_POINT_16") = {p52};
Physical Point("FRACTURE_INTERSECTION_POINT_17") = {p55};
Physical Point("FRACTURE_INTERSECTION_POINT_18") = {p56};
Physical Point("FRACTURE_INTERSECTION_POINT_19") = {p57};
Physical Point("FRACTURE_INTERSECTION_POINT_20") = {p58};
Physical Point("FRACTURE_INTERSECTION_POINT_21") = {p59};
Physical Point("FRACTURE_INTERSECTION_POINT_22") = {p60};
Physical Point("FRACTURE_INTERSECTION_POINT_23") = {p61};
Physical Point("FRACTURE_INTERSECTION_POINT_24") = {p62};
Physical Point("FRACTURE_INTERSECTION_POINT_25") = {p63};
Physical Point("FRACTURE_INTERSECTION_POINT_26") = {p64};
